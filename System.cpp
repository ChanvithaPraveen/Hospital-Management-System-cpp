...
void System::readData(Patient patients[], Medicine medicines[], int &numPatients, int &numMedicines, const string& filename) {
...
void System::writeData(Patient patients[], Medicine medicines[], int numPatients, int numMedicines, const string& filename) {
